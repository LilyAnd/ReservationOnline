    ...
    <div class="row">
        ...
        <div class="col-sm-3 col-md-9">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('admin.postSetting') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label for="phone_number" class="col-md-4 control-label">Start Time</label>

                            <div class="col-md-6">
                                <input id="start_time" type="text" class="form-control" name="start_time" value="{{$user->start_time}}" required>
                            </div>
                        </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="end_time" type="text" class="form-control" name="end_time" value="{{$user->end_time}}" required>
                            </div>
                        </div>
